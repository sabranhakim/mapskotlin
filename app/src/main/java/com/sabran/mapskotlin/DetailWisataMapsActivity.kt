...
import com.sabran.mapskotlin.databinding.ActivityDetailWisataMapsBinding
...
class DetailWisataMapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        btnLokasi.setOnClickListener {
            val intentMapsWisata = Intent(this, MapsWisataActivity::class.java)
            //kirim lat dan long
            intentMapsWisata.putExtra("latWisata", latWisata)
            intentMapsWisata.putExtra("longWisata", longWisata)
            intentMapsWisata.putExtra("namaLokasiWisata", namaLokasiWisata)
            startActivity(intentMapsWisata)
        }
